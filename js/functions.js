...
$(function () {
    ...
    gardenCanvas.width = $("#loveHeart").width()*1.75;
    gardenCanvas.height = $("#loveHeart").height()*1.75;
...
function adjustWordsPosition() {
    ...
    $("#words").css("top", $("#garden").position().top + 195/3 +20);
    $("#words").css("left", $("#garden").position().left + 70/3)
}
